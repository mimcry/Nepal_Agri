...
const Category = () => {
    ...
    const fetchWeather = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(`Error: ${errorData.message} (Status Code: ${response.status})`);
        }
  ...
  return (
    <React.Fragment>
         <div>
      <h2>Weather Data</h2>
      <p>Current Temperature: {weatherData.current.temp} K</p>
              ...
              <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
                ...
                >
                  ...
                  <Box sx={{ padding: 2,paddingTop:1 }}>
                    ...
                    <Typography>Location: <span style={{backgroundColor:"green",padding:1,paddingLeft:3,paddingRight:3,color:"white"}}> Dhulikhel</span></Typography>
                    <Box sx={{display:"flex",mt:1}}>
                      
                        <Typography>Quantity: 10 kG</Typography>

                        <Typography sx={{ml:"auto"}}>Price: <span style={{color:"green",fontWeight:"bold"}}> Rs.15</span></Typography>
